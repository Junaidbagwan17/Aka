...
function App() {
  ...
  const servicesData = [
    { img: "/gallery1.jpg", category: "SKIN SERVICES", title: "Threading", desc: "Experience the precision of beauty with our expert Threading service." },
    { img: "/gallery2.jpg", category: "SKIN SERVICES", title: "Special Treatments", desc: "Enjoy our Special Treatments that are available to you only..." },
    { img: "/gallery3.jpg", category: "SKIN SERVICES", title: "Skin Rejuvenating Face Masques", desc: "Our Face Rejuvenating Masques will make your face glow beautifully." }
  ];
    ...
    try {
      ...
      await emailjs.send(
        ...
        'template_xryylhu',
        {
          to_name: name,
          to_email: email,
          salon_name: "Akshay Salon",
          salon_phone: "+91 98765 43210",
          salon_address: "Shop No. 5, Sai Plaza, Vasai East",
          salon_email: "akshaysalon@gmail.com"
        },
        'oGzr3OBjpPBEt2Hvp'
      );

      // Send to SALON (your notification)
      await emailjs.send(
        'service_tqi5ucb',
        'template_tcb6bgr',
        {
        ...
        return (
          <>
            ...
            <div className="link-buttons">
              ...
              <a href="https://instagram.com/akshaysalon_real" className="link-card" target="_blank" rel="noreferrer">
            ...
            <div className="appointment-form">
              ...
              {sendStatus === 'success' ? (
                <div className="success-message">✅ Confirmation sent! Check your email.</div>
              ) : sendStatus === 'error' ? (
                <div className="error-message">❌ Failed to send. Please WhatsApp us directly.</div>
              ) : (
          ...
          <div className="contact-tab">
            ...
            <div className="contact-cards">
              <div className="contact-card">
                ...
                <h4>Location</h4>
                <p>Shop No. 5, Sai Plaza<br />Vasai East, Mumbai</p>
              ...
              <div className="contact-card">
                ...
                <h4>Call/WhatsApp</h4>
                <p>+91 98765 43210<br />10AM - 8PM Daily</p>
